...
var review_manager_component_1 = __webpack_require__(19);
var customer_component_1 = __webpack_require__(16);
...
AppModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [
            ...
            review_manager_component_1.ReviewManagerComponent
        ],
        imports: [
            ...
            router_1.RouterModule.forRoot([
                ...
                { path: 'review-manager', component: review_manager_component_1.ReviewManagerComponent },
...
(function (global, factory) {
     true ? factory(exports, __webpack_require__(1), __webpack_require__(3), __webpack_require__(33), __webpack_require__(4), __webpack_require__(32)) :
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(1);
var customer_product_service_1 = __webpack_require__(20);
var CustomerComponent = (function () {
    function CustomerComponent(productService) {
        this.productService = productService;
    }
    CustomerComponent.prototype.updateProducts = function () {
        console.log("UPDATE PRODUCTS");
        this.getProducts();
    };
    CustomerComponent.prototype.getProducts = function () {
        var _this = this;
        return this.productService.getProducts("CHANGEME").then(function (p) {
            _this.productViewModel = p;
            _this.products = p.products;
...
CustomerComponent = __decorate([
    core_1.Component({
        ...
        providers: [customer_product_service_1.CustomerProductService]
    }),
    __metadata("design:paramtypes", [customer_product_service_1.CustomerProductService])
], CustomerComponent);
...
var ReviewManagerComponent = (function () {
    function ReviewManagerComponent(http) {
        var _this = this;
...
ReviewManagerComponent = __decorate([
    core_1.Component({
...
exports.ReviewManagerComponent = ReviewManagerComponent;
...
Object.defineProperty(exports, "__esModule", { value: true });
var product_viewmodel_component_1 = __webpack_require__(17);
var core_1 = __webpack_require__(1);
var http_1 = __webpack_require__(5);
__webpack_require__(28);
var CustomerProductService = (function () {
    function CustomerProductService(http) {
        this.http = http;
        this.productUrl = '/api/CustomerReview/MyProductsAndReviews';
    }
    CustomerProductService.prototype.getProducts = function (customerName) {
        return this.http.get(this.productUrl)
            .toPromise()
            .then(this.extractData)
            .catch(this.handleError);
    };
    CustomerProductService.prototype.extractData = function (res) {
        console.log('successfully extracted');
        var body = res.json();
        var viewModel = new product_viewmodel_component_1.ProductViewModel(body.data.map(function (p) { return p.name; }));
        console.log(viewModel);
        return viewModel || { products: [] };
    };
    CustomerProductService.prototype.handleError = function (error) {
...
CustomerProductService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http])
], CustomerProductService);
exports.CustomerProductService = CustomerProductService;
...
module.exports = "<h1>Customer</h1>\r\n\r\n<p>Yes, there is no security on this whatsoever</p>\r\n\r\n<input class=\"customer-name\" [(ngModel)]=\"name\" (input)=\"updateProducts()\" placeholder=\"Name\">\r\n<input [(ngModel)]=\"email\" placeholder=\"Email address\">\r\n<div *ngIf=\"name\">\r\n  <div>Hello {{name}}, select a product to review:</div>\r\n  <ul *ngIf=\"productViewModel\">\r\n    <li *ngFor=\"let product of productViewModel.products\" class=\"customer-product\">{{product}}</li>\r\n  </ul>\r\n</div>";

/***/ }),
/* 26 */
/***/ (function(module, exports) {

module.exports = "<div class='main-nav'>\r\n    <div class='navbar navbar-inverse'>\r\n        <div class='navbar-header'>\r\n            <button type='button' class='navbar-toggle' data-toggle='collapse' data-target='.navbar-collapse'>\r\n                <span class='sr-only'>Toggle navigation</span>\r\n                <span class='icon-bar'></span>\r\n                <span class='icon-bar'></span>\r\n                <span class='icon-bar'></span>\r\n            </button>\r\n            <a class='navbar-brand' [routerLink]=\"['/customer']\">ReviewManagement</a>\r\n        </div>\r\n        <div class='clearfix'></div>\r\n        <div class='navbar-collapse collapse'>\r\n            <ul class='nav navbar-nav'>\r\n                <li [routerLinkActive]=\"['link-active']\">\r\n                    <a [routerLink]=\"['/customer']\">\r\n                        <span class='glyphicon glyphicon-education'></span> Customer\r\n                    </a>\r\n                </li>\r\n                <li [routerLinkActive]=\"['link-active']\">\r\n                    <a [routerLink]=\"['/review-manager']\">\r\n                        <span class='glyphicon glyphicon-th-list'></span> Review Manager\r\n                    </a>\r\n                </li>\r\n            </ul>\r\n        </div>\r\n    </div>\r\n</div>";
...
var toPromise_1 = __webpack_require__(3);
